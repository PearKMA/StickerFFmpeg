package com.pear.ffmpegsticker.image.custom;
...
public abstract class StickerView extends FrameLayout {
    ...
    //add
    private StickerInterface stickerInterface;
    ...
    private void init(Context context, boolean isEdit){
        this.isEdit = isEdit;
        ...
        //addInterface
        try {
            stickerInterface=(StickerInterface)context;
        }catch (ClassCastException e) {
            throw new ClassCastException(context.toString() + " must implement StickerInterface");
        }
        ...
        this.iv_delete.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if(StickerView.this.getParent()!=null){
                    ...
                    stickerInterface.onDeleteSticker(StickerView.this);
                }
            }
        });
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (endTime - startTime < 200) {
                            stickerInterface.onStickerClicked(StickerView.this);
                        }
